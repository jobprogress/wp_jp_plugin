...
define('JOBPRGRESS_AUTHORIZATION_URL', 'http://api.job_progress.dev/api/v1/oauth2/authorization');
define('JOBPRGRESS_DISCONNECT_URL', 'http://api.job_progress.dev/api/v1/oauth2/disconnect');
define('JOBPRGRESS_REFRESH_TOKEN_URL', 'http://api.job_progress.dev/api/v1/oauth2/renew_access_token');
