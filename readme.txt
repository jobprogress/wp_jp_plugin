...
3. Use the jobprogress->jobprogress screen to configure the subscriber account.
4. After connect the account use the shortcde which showning the top of that screen.