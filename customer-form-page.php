...
<form class="customer-page customer-page-container" method="post" id = "jobprogrssCustomerSignupForm" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
	<div class="jp-customer-form-wrap">
		<div class="form-group form-group-input jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['customer_type']['position'] ?>;">
		...
		<div class="inline-fields-row jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['customer_name']['position'] ?>;">
		...
		<?php if($jp_customer_form_fields['customer_name_commercial']['isActive'] != 1) { ?>
			<div class="inline-fields-row jobprogress-commercial-type jp-customer-form-field" style="display:none; order: <?php echo $jp_customer_form_fields['customer_name']['position'] ?>;">
				<div class="inline-fields-col">
		...
		<?php } ?>
		<div class="form-group form-group-input jobprogress-commercial-type jp-customer-form-field" style="display:none; order: <?php echo $jp_customer_form_fields['company_name']['position'] ?>;">
		...
		<?php if($jp_customer_form_fields['company_name']['isActive'] != 1) { ?>
			<div class="form-group form-group-input jobprogress-residential-type jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['company_name']['position'] ?>;">
		...
		<?php } ?>
		<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['customer_phone']['position'] ?>;">
		...
		<?php if($jp_customer_form_fields['customer_email']['isActive'] != 1) { ?>
			<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['customer_email']['position'] ?>;">
		...
		<?php } ?>
		<?php if($jp_customer_form_fields['customer_address']['isActive'] != 1) { ?>
			<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['customer_address']['position'] ?>;">
				<div class="form-group form-group-input">
		...
		<?php } ?>
		<?php if($jp_customer_form_fields['billing_address']['isActive'] != 1) { ?>
			<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['billing_address']['position'] ?>;">
		...
		<?php } ?>
		<?php if($jp_customer_form_fields['referred_by']['isActive'] != 1) { ?>
			<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['referred_by']['position'] ?>;">
		...
		<?php } ?>
		<div class="jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['trades']['position'] ?>;">
		...
		<div class="form-group form-group-input jp-customer-form-field" style="order: <?php echo $jp_customer_form_fields['description']['position'] ?>;">
